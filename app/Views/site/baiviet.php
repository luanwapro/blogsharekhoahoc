...
<div class="col-12 col-lg-8">
                    ...
                    <div class="world-catagory-area">
                          ...
                          <ul class="nav nav-tabs" id="myTab" role="tablist">
                              ...
                              <li class="title"><?= $baivietdangxem[0]->tenkhoahoc  ?></li>
                    ...
                    <?= $baivietdangxem[0]->noidung  ?>
                  
                    <div style="text-align: center;">
                   
                    <a href="  <?= $baivietdangxem[0]->link  ?>" type="button" target="_blank" style="width: 30%;margin-left: 30%;" class="btn btn-block bg-gradient-success">Link Tải</a>
...
function xemthem(){
    ...
    $.post('<?php echo base_url() ?>/xemthem',{'page':"bv-<?= $baivietdangxem[0]->id_chude  ?>",'landem':dem},function(data){
